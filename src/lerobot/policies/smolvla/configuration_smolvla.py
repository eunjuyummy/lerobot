...
class SmolVLAConfig(PreTrainedConfig):
    ...
    # Image preprocessing
    resize_imgs_with_padding: tuple[int, int] = (256, 256)  #(512, 512)
    ...
    def __post_init__(self):
        ...
        # Ensure padded tactile dimension is always defined.
        # `VLAFlowMatching` unconditionally instantiates `tactile_proj`, which requires
        # an int in_features.
        if self.max_tactile_dim is None:
            self.max_tactile_dim = int(self.tactile_state_dim)
